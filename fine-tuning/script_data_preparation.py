...
# dataset.to_csv('fine-tuning/data/medquad_converted.csv', index=False)

# Crea una lista per contenere tutti i messaggi nel formato richiesto
messages = []
...
# Salva il contenuto nel formato JSONL
